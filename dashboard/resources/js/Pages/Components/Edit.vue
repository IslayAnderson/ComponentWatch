...
const props = defineProps({ site: Object, component: Object })
...
function submit() {
    form.put(route('sites.components.update', [props.site.id, props.component.id]))
}
</script>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div>
                ...
                <h2 class="text-xl font-semibold text-gray-800">Edit Component</h2>
            </div>
        </template>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between rounded border border-gray-200 bg-gray-50 px-4 py-3">
                        <div>
                            ...
                            <p class="text-xs text-amber-500 mt-1">⚠ Effectiveness depends on the browser and device. Some screenshot shortcuts are intercepted before the browser can react.</p>
                        </div>
