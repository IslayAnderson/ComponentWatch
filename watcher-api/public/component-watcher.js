...
function h(e) {
	...
	for (let e of t) try {
		...
		console.warn(`[ComponentWatcher] Screenshot macro failed (${e.type})`, t);
	}
	return null;
}
//#endregion
...
var g = { async init({ apiUrl: e, siteKey: t }) {
	...
	try {
		let t = await fetch(`${e}/api/components`, { headers: n });
		if (!t.ok) throw Error(`HTTP ${t.status}`);
		r = (await t.json()).components;
	} catch (e) {
